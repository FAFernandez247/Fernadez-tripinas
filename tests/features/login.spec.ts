...
test.describe('Case Sensitivity Behavior', { 
  ...
  users.forEach(user => {
    test('Verify username is case-insensitive', { tag: ["@Validation", "@Case-Sensitivity"] }, async ({ loginPage }) => {
    ...
    test('Verify email address is case-insensitive', { tag: ["@Validation", "@Case-Sensitivity"] }, async ({ loginPage }) => {
    ...
    test('Verify password is case-sensitive', { tag: ["@Validation", "@Case-Sensitivity"] }, async ({ loginPage }) => {
...
test.describe('Login UI and Navigation', {
  ...
  users.forEach(user => {
    ...
    test('Verify navigation from Login page to Registration page', { tag: ["@Navigation"] }, async ({ loginPage, registerPage }) => {
    ...
    test('Verify navigation from Registration page back to Login page', { tag: ["@Navigation"] }, async ({ loginPage, registerPage }) => {
      await test.step('Click "Sign Up" link', async () => {
        await loginPage.clickSignUpLink();
      });
      await test.step('Verify user is navigated to Registration page and UI elements are visible', async () => {
...
test.describe('Session Handling', {annotation: { type: 'session', description: 'Tests session behavior when navigating back or logging out' }
}, async () => {
  users.forEach(user => {
    test.beforeEach(async ({ loginPage }) => {
      await loginPage.navigateToLogin();
    ...
    test('Verify that once logged in, clicking back button doesn\'t logout user', async ({ loginPage }) => {
    ...
    test('Should be able to logout account', async ({ loginPage, profilePage }) => {
    ...
    test('Verify that once logged out, clicking back button doesn\'t login user', async ({ loginPage, profilePage }) => {
      await test.step('Click the icon in the top-right corner', async () => {
        await profilePage.clickIcon();
      });
      await test.step('Click "Sign out" button', async () => {
